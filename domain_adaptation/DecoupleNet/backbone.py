...
from models.segformer_utils.timm import trunc_normal_, drop_path
...
class OverlapPatchEmbed(nn.Module):
    def __init__(self, patch_size, stride: int, in_chans: int, embed_dim: int):
        super().__init__()
