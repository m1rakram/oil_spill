...
class SegFormerHead(nn.Module):
    def __init__(self, in_channels, embed_dim, dropout_p=0.1, align_corners=False):
        super().__init__()
...
class Segmentation_head(nn.Module):
    def __init__(self, num_classes, embed_dim, align_corners = False):
        super().__init__()
        self.embed_dim = embed_dim
        self.align_corners = align_corners
...
class Classification_head(nn.Sequential):
    def __init__(self, in_channels, num_classes, embed_dim, dropout_p=0.1, align_corners=False):
        ...
        self.linear = nn.Linear(800, num_classes)
